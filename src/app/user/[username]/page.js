...
>
  ...
  {
    getFriends.result.length!=0? <Grid className='friendContainer'  item >
    <FriendsContainerUser token={getTokenofme()} username={username}  page={parseInt(getFriends.page)} totalPages={parseInt(getFriends.totalpages)} freinds={getFriends.result}></FriendsContainerUser>
  </Grid>:<Grid></Grid>
  }
  ...
  <Grid className="informationContainer"  container direction={"row"} alignItems={"center"} justifyContent={"center"} item >
    ...
    imagesSuccespro={portImage.success} imagesSucces={profileImage.success} imagenprofile={profileImage.urlprofile} token={getTokenofme()} username={username}
     ...
     description={description.description!=[]?description.description.description:null}
  ...
  {
    allImages.result.length!=0? <Grid className="imagesAllContainer" item >
    <ImagesUsersameCon username={username} token={getTokenofme()} images={allImages?.result?allImages.result:[]} 
...
<PostContainer username={username} token={getTokenofme()} 
allpublication={posts.result}
 allapuntes={apuntes.result} totalPagesPubl={posts.totalpages} totalPagesApu={apuntes.totalpages}
  pageApu={apuntes.page} pagepu={posts.page} imagende={profileImage.urlprofile} >
