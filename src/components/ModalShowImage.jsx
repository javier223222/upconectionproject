  ...
  return (
    <div>
        <Modal open={props.open} onClose={props.close}>
          {
            props.type?<Image className='imageShow' style={{...stylestwo,width:"600"}} width={"400"} height={"250"}  src={props.image}></Image>:<Image className='profile' style={{position: 'absolute',
            top: '50%',
            left: '50%',
